...
$(document).ready(function() {
    ...
    $('#example2 tbody td i').live('click', function () {
        ...
        else
        {
            ...
            oTable.fnOpen( nTr, fnFormatDetailsUser(oTable, nTr), 'details' );
        }
    });
...
function fnFormatDetailsUser ( oTable, nTr )
{
    var aData = oTable.fnGetData( nTr );
    var sOut = '<table cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;" class="inner-table">';
    sOut += '<tr><td><img src="resource/img/profiles/1.png" ></td></tr>';
    sOut += '<tr><td>First Name:</td><td>'+aData[1]+'</td></tr>';
    sOut += '<tr><td>Last Name:</td><td>'+aData[2]+'</td></tr>';
    sOut += '<tr><td>Nationality:</td><td>'+aData[3]+'</td></tr>';
    sOut += '<tr><td>Portfolio Value:</td><td>'+aData[4]+'</td></tr>';
    sOut += '</table>';
